...
# load data
#####
cons <- readRDS('data/wgcna/tri_consensus_wgcna_objs.R')
nodes <- read_delim('data/wgcna/tri_consensus.nodes',delim='\t')
...
write_delim(nodes,'data/wgcna/tri_consensus.nodes.1',delim='\t')
